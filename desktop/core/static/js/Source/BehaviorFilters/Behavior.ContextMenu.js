...
Behavior.addGlobalFilters({
	...
	ContextMenu: function(element, events){
		...
		var contents = events.getContentElement();
		
		//create an instance of CCS.Context menu for each delegate
		var menu = new JframeContextMenu(element, {
			   applyDelegates: events.applyDelegates, //pass a function that wraps this jframe instance
